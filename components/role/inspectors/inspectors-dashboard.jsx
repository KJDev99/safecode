...
export default function InspectorsDashboard() {
    ...
    return (
        <div>
            ...
            <div
                className='p-6 rounded-[12px] bg-white grid grid-cols-2 mt-6 max-md:grid-cols-1 max-md:gap-4'
            ...
            >
                <div className="flex flex-col max-md:mb-4">
                    ...
                    <p className={`text-[#1E1E1E99] leading-[120%] grow max-md:text-sm`}>
                        Быстро найдите заявку для обслуживания объекта
                    </p>
                </div>
                <div className="flex justify-end max-md:justify-start">
                    <Button
                        text={'Перейти'}
                        className='h-[66px] w-[368px] max-md:h-[56px] max-md:text-sm max-md:w-full'
                    />
                </div>
            </div>
            ...
            <div
                ...
                style={{ boxShadow: '0px 0px 4px 0px #76767626' }}
            >
                <Title text={'Последняя активная заявка'} size="text-lg max-md:text-base" />
                <div className="flex gap-4 items-center mt-6">
                    ...
                    <div className="flex flex-col">
                        <h3 className='text-[#2C5AA0] mb-2 text-lg max-md:text-base'>Проверка системы пожаротушения</h3>
                        <p className='text-[#1E1E1E99] mt-0 max-md:text-sm'>
                            Проверка системы пожаротушения - ТЦ "Галлерея"
                        </p>
                    </div>
                </div>
            </div>
