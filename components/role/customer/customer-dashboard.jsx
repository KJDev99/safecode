        ...
        <div>
            <div className="flex justify-between items-center">
                <div className="flex flex-col">
                    <Title text={'Добро пожаловатать, User 424256!'} size={'text-[24px]'} />
            ...
            <div className="grid grid-cols-2 gap-6 mt-6">
                ...
                >
                    <Title text={'Услуга активна'} color="text-[#2C5AA0]" size="text-lg max-md:text-base" cls={"mb-3"} />
                    <p className={`text-[#1E1E1E99] leading-[120%] grow max-md:text-sm mb-6`}> “Профессиональный пакет” - услуга уже <br /> ваша </p>
                ...
                <div
                    ...
                    style={{ boxShadow: '0px 0px 4px 0px #76767626' }}
                >
                    <Title text={'Новая заявка'} color="text-[#2C5AA0]" size="text-lg max-md:text-base" cls={"mb-3"} />
                    <p className={`text-[#1E1E1E99] leading-[120%] grow max-md:text-sm mb-6`}> Быстро создать новую задачу или заявку для обслуживания объекта </p>
                    <Button icon={<LuPlus />} text={'Создать заявку'} className='h-[66px] w-full max-md:h-[56px] max-md:text-sm gap-2' />
                </div>
                <div
                    className='p-6 rounded-[12px] bg-white flex flex-col'
                    style={{ boxShadow: '0px 0px 4px 0px #76767626' }}
                >
                    ...
                    <p className={`text-[#1E1E1E99] leading-[120%] grow max-md:text-sm mb-6`}> Заполнить электронный журнал выполненных работ по объекту </p>
                    <Button icon={<CiEdit />} text={'Смотреть журнал'} className='h-[66px] w-full max-md:h-[56px] max-md:text-sm gap-2 bg-[#E2E2E2] !text-[#8E8E8E]' />
                </div>
            </div>
