...
export default function InspectorsObject() {
    return (
        <div>
            <div className="flex justify-between items-center">
                <div className="flex flex-col">
                    <Title text={"Мои объекты"} size={"text-[24px]"} cls="uppercase" />
                    <p className="text-[#1E1E1E]/60 mt-3">Ваши объекты, которые вы проверяете</p>
                </div>
            </div>
