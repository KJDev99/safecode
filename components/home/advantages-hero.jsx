...
export default function AdvantagesHero() {
    return (
        <div className='max-w-[1200px] mx-auto my-[100px] '>
            <Title text='Преимущества системы' cls="mb-8" />
            <div className="grid grid-cols-3 gap-6">
                <Image src={'/advantages-hero.png'} alt='advantages-hero' width={384} height={400} className='w-full rounded-[12px] row-span-3 h-full' />
